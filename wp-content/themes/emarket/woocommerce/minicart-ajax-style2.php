		...
		<div class="minicart-padding">
						...
						<div class="detail-item">
							<div class="product-details"> 
								...
								<div class="product-action clearfix">
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="btn-remove" title="%s"><span class="fa fa-trash-o"></span></a>', esc_url( $woocommerce->cart->get_remove_url( $cart_item_key ) ), esc_html__( 'Remove this item', 'emarket' ) ), $cart_item_key ); ?>           
			...
			<div class="cart-checkout">
				...
				<div class="cart-links clearfix">
					<div class="cart-link"><a href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>/cart" title="<?php esc_attr_e( 'Cart', 'emarket' ) ?>"><?php esc_html_e('View rt', 'emarket'); ?></a></div>
