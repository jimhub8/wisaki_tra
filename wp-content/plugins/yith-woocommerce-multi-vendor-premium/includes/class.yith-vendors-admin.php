...
if ( !class_exists( 'YITH_Vendors_Admin' ) ) {
    ...
    class YITH_Vendors_Admin {
        ...
        public function register_panel() {
	        ...
	        $menu_title = $page_title = sprintf( '%s %s', _x( 'Multi', '[Part of] Multi Vendor', 'yith-woocommerce-product-vendors' ), YITH_Vendors()->get_singular_label( 'ucfirst' ) );;
            $args = array(
        ...
        public function menu_items() {
            ...
            $menu_title = $page_title = sprintf( '%s %s', YITH_Vendors()->get_singular_label( 'ucfirst' ), _x( 'Profile', '[Part of] Vendor Profile', 'yith-woocommerce-product-vendors' ) );;
