...
if ( ! empty( $vendor->header_image ) && 'small-box' == $header_skin && 'background' == $header_image_html && ! empty( $header_image[0] ) ) {
...
<div class="<?php echo $store_header_class . ' ' . $header_skin . ' ' . $header_image_class  ?>" style="<?php echo $wrapper_style ?>">
    <!--  Header Image -->
	<?php if ( ! empty( $vendor->header_image ) && ( 'image' == $header_image_html || 'double-box' == $header_skin ) ): ?>
