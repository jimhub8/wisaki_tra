        ...
        'carrier_settings' => array(
            ...
            'fields' => array(
                'ywcdd_dayrange' => array(
                    ...
                    'desc' => __('Set the number of days essential to your carrier to deliver the order (Set 0 as value if the delivery occurs within the day)','yith-woocommerce-delviery-date'),
                    'type' => 'number',
                    'min'   => 0,
                    'std' => 3
                ),
