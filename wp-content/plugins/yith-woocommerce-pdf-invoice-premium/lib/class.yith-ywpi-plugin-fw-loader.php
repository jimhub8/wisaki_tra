...
//            $admin_tabs[ 'columns' ]  = __ ( 'Fields Names', 'yith-woocommerce-pdf-invoice' );
        ...
        public function action_links ( $links ) {
            ...
            if( ! defined( 'YITH_YWPI_FREE_INIT' ) && class_exists( 'YIT_Plugin_Licence' ) ){
         ...
         * @use      plugin_row_meta
         */
        public function plugin_row_meta ( $plugin_meta, $plugin_file, $plugin_data, $status, $init_file = 'YITH_YWPI_INIT' ) {
            ...
            if ( defined( 'YITH_YWPI_FREE_INIT' ) && YITH_YWPI_FREE_INIT == $plugin_file ) {
                $to_add[] = array(
