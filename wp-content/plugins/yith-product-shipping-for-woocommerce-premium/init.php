 ...
 * Description: Create general shipping rules or rules per single product.
 * Version: 1.0.12
 * Author: YITHEMES
 ...
 *
 * @author  YITHEMES
 * @package YITH Product Shipping for WooCommerce
 * @version 1.0.0
 */
...
if ( ! function_exists( 'yith_wcps_install_free_woocommerce_admin_notice' ) ) {
	...
	function yith_wcps_install_free_woocommerce_admin_notice() {
		?>
		<div class="error">
			<p><?php _e( 'YITH Product Shipping for WooCommerce is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-product-add-ons' ); ?></p>
		</div>
	<?php
	}
}
...
if ( defined( 'YITH_WCPS_PREMIUM' ) ) {
	function yith_wcps_install_free_admin_notice() {
		?>
		<div class="error">
			<p><?php _e( 'You can\'t activate the free version of YITH Product Shipping for WooCommerce while you are using the premium one.',
                    'yith-woocommerce-product-add-ons' ); ?></p>
		</div>
		<?php
	}
...
! defined( 'YITH_WCPS_VERSION' )				&& define( 'YITH_WCPS_VERSION', '1.0.12' );
! defined( 'YITH_WCPS_DB_VERSION' )				&& define( 'YITH_WCPS_DB_VERSION', '1.0.11' );
