	...
	>
		...
		<div class="sui-box" role="document">
			...
			<div class="sui-box-header sui-flatten sui-content-center">
				...
				<button class="sui-button-icon sui-button-float--right" data-modal-close>
					...
					<span class="sui-screen-reader-text"><?php esc_html_e( 'Close this dialog', 'wordpress-popup' ); ?></span>
				</button>

				<h3 id="hustle404Downgrade" class="sui-box-title sui-lg">
					<?php /* translators: version to rollback into. */ ?>
					<?php printf( esc_html__( 'Rollback to Hustle %s', 'wordpress-popup' ), esc_html( $new_version ) ); ?>
				</h3>

				<p class="sui-description">
					<?php /* translators: version to rollback into. */ ?>
					<?php printf( esc_html__( 'Follow the instructions below to downgrade Hustle to %s.', 'wordpress-popup' ), esc_html( $new_version ) ); ?>
				</p>
			...
			<div class="sui-box-body">
				...
				<?php
					printf(
						...
						esc_html__( '2. Delete Hustle %2$s, so you could install %1$s in the next step.', 'wordpress-popup' ),
						esc_html( $new_version ),
						esc_html( $current_version )
					);
					?>
				...
				<?php
					printf(
						...
						esc_html__( '3. %1$sDownload Hustle %4$s%3$s and install it by manually uploading it on the Plugins page. You can refer to the %2$swp.org guide%3$s on installing a plugin from a zip file.', 'wordpress-popup' ),
			...
			<div class="sui-box-footer sui-content-right">
				<a href="<?php echo esc_url_raw( $visibility_restore_url ); ?>" class="sui-button hustle-load-on-click">
					<span class="sui-loading-text"><?php esc_html_e( 'Rollback Database & Deactivate', 'wordpress-popup' ); ?></span>
		...
		<?php
			printf(
				...
				esc_html__( 'Having trouble downgrading? %1$sContact support%2$s', 'wordpress-popup' ),
