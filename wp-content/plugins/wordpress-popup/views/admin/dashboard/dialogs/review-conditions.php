				...
				<li class="sui-current sui-loaded" data-slide="1">
					...
					<div class="sui-box">
						...
						<div class="sui-box-header sui-lg sui-block-content-center">
							...
							<h2 id="dialogTitle" class="sui-box-title"><?php esc_html_e( 'We\'ve fixed visibility conditions!', 'wordpress-popup' ); ?></h2>

							<span id="dialogDescription" class="sui-description"><?php printf( esc_html__( 'Prior to Hustle %s, the visibility engine would require you to set rules for each and every post type your theme used, not just the ones you specified. We\'ve updated this behaviour to only display modules based on the post types explicitly defined in your conditions.', 'wordpress-popup' ), esc_attr( $version ) ); ?></span>
						...
						<div class="sui-box-body">
							<h4><?php esc_html_e( 'Examples', 'wordpress-popup' ); ?></h4>

							<span class="sui-description"><?php esc_html_e( 'Let\'s take a couple of examples of "Pages" condition to understand how visibility behavior has changed with this bug fix: ', 'wordpress-popup' ); ?></span>
							<?php /* translators: 1. opening 'u' tag, 2. closing 'u' tag */ ?>
							<br><b><?php printf( esc_html__( '1. %1$sPages -> Only 2%2$s', 'wordpress-popup' ), '<u>', '</u>' ); ?></b>
							<span class="sui-description"><?php printf( esc_html__( 'In %1$s, your module with the above condition will appear on the two selected pages only. Whereas, before %1$s, it would have appeared on the two chosen pages and other post types (such as posts, categories, tags) as well, unless you individually add a condition to not show your module on them.', 'wordpress-popup' ), esc_attr( $version ) ); ?></span>
							<?php /* translators: 1. opening 'u' tag, 2. closing 'u' tag */ ?>
							<b><?php printf( esc_html__( '2. %1$sPages -> All except 2%2$s', 'wordpress-popup' ), '<u>', '</u>' ); ?></b>
							<span class="sui-description"><?php printf( esc_html__( 'In %1$s, your module will appear on all pages except the two selected pages, and it won\'t appear on other post types such as posts, categories, or tags unless you explicitly add a condition for them. Whereas, before %1$s, this would have appeared across your website except on the two selected pages.', 'wordpress-popup' ), esc_attr( $version ) ); ?></span>

						</div>

						<div class="sui-box-body">
							<h4><?php esc_html_e( 'Recommended Actions', 'wordpress-popup' ); ?></h4>

							<span class="sui-description"><?php esc_html_e( '1. Review all your active modules\' visibility behavior to ensure that they appear on correct pages.', 'wordpress-popup' ); ?></span>
							<span class="sui-description">
							<?php
								printf(
									/* translators: 1. opening 'a' tag to support, 2. closing 'a' tag */
									esc_html__( '2. Unable to make the visibility conditions work correctly? %1$sContact Support%2$s.', 'wordpress-popup' ),
							...
							<?php
								printf(
									...
									esc_html__( '3. Not yet ready for the new visibility behavior? Go to the Plugins page and use the "%1$sRollback to %3$s%2$s" link below Hustle to downgrade Hustle to %3$s.', 'wordpress-popup' ),
									'<b>',
									'</b>',
						...
						<div class="sui-box-footer">
							...
							>
								<?php esc_html_e( 'Review Modules', 'wordpress-popup' ); ?>
							</button><br>
					...
					<p class="sui-onboard-skip"><a href="#" data-a11y-dialog-hide="hustle-dialog--review_conditions"><?php esc_html_e( 'I\'ll check this later', 'wordpress-popup' ); ?></a></p>
